...
3. Motivación
La gestión de bienes raíces suele enfrentarse a problemas de redundancia de datos y falta de seguimiento en los pagos. Este proyecto nace del interés por aplicar los conceptos de Normalización de Bases de Datos en un escenario del mundo real.
